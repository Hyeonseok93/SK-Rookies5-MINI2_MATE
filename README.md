...
<table align="center">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="left">컨텍스트·JPA 매핑·권한·JWT·CSRF·삭제/복구 수명주기 회귀 검증</td>
    </tr>
  </tbody>
</table>
...
- 모든 도메인 엔티티는 `deleted_at` 기반 **Soft Delete**(`@Where`)를 공통 적용하고, 인증은 **JWT + RefreshToken**(1인 1토큰), 관리자 작업은 **AdminLog**로 남깁니다.
